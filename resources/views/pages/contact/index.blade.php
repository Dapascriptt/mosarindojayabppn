...
<div class="relative left-1/2 -translate-x-1/2 w-screen">
  <section class="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
    <div class="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center opacity-25"></div>
    ...
    <div class="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-10 py-14 sm:py-16 space-y-3">
      ...
      <h1 class="text-3xl sm:text-4xl font-extrabold leading-tight">Kami siap membantu proyek Anda</h1>
      <p class="text-base sm:text-lg text-slate-100/90 max-w-3xl">
        Sampaikan kebutuhan showroom, konstruksi, interior, electrical, supply material, atau land clearing.
...
<div class="relative left-1/2 -translate-x-1/2 w-screen bg-slate-50 py-10 sm:py-12">
  <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-10 grid gap-8 lg:grid-cols-[1.15fr_0.85fr] items-start">
    ...
    <div class="rounded-2xl bg-white p-6 sm:p-7 shadow-sm ring-1 ring-slate-200">
      <h2 class="text-xl font-extrabold text-slate-900">Form Kontak</h2>
      <p class="mt-2 text-sm text-slate-600">Isi data di bawah, kami akan menghubungi Anda.</p>
    ...
    {{-- Info --}}
    <div class="rounded-2xl bg-white p-6 sm:p-7 shadow-sm ring-1 ring-slate-200">
      <h2 class="text-xl font-extrabold text-slate-900">Kontak Kami</h2>

      <div class="mt-4 rounded-xl bg-slate-50 p-4 ring-1 ring-slate-200">
        <p class="text-sm font-extrabold text-slate-900">PT. Mosarindo Jaya Balikpapan</p>
        <p class="mt-2 text-sm text-slate-700 leading-relaxed">
          Jl. Komp. Bukit Damai Lestari Blok IV No. 3-4 RT. 44 Kel. Gn. Bahagia Kec. Balikpapan Selatan<br>
          Balikpapan - KALTIM
        </p>
      </div>
      ...
      <div class="mt-5 space-y-3 text-sm">
        <div class="flex items-center justify-between gap-3 rounded-xl bg-white p-3 ring-1 ring-slate-200">
          ...
          <a href="https://wa.me/6281254899699" class="font-bold text-[rgba(219,165,84,1)] hover:text-[rgba(219,165,84,1)]">
            +62 812 5489 9699
          </a>
        </div>
        ...
        <div class="flex items-center justify-between gap-3 rounded-xl bg-white p-3 ring-1 ring-slate-200">
          ...
          <a href="mailto:info@Mosarindo.com" class="font-bold text-[rgba(219,165,84,1)] hover:text-[rgba(219,165,84,1)]">
            info@Mosarindo.com
          </a>
        </div>
      </div>
      ...
      <div class="mt-5 flex flex-wrap gap-2">
        <a href="https://wa.me/6281254899699"
        ...
        <a href="mailto:info@Mosarindo.com"
...
<div class="relative left-1/2 -translate-x-1/2 w-screen">
  <section class="bg-white">
    <iframe
      ...
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.1827836090397!2d110.406005!3d-7.761694!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a5a3b76e85c9d%3A0x65c02e4b97b34f05!2sYogyakarta!5e0!3m2!1sen!2sid!4v1700000000000!5m2!1sen!2sid"
      style="border:0;"
      allowfullscreen=""
      loading="lazy"
