    ...
    <div class="row g-4">
        <div class="col-12 col-xl-8">
            <div class="admin-card rounded-4 bg-white p-4">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="short_desc" rows="3" class="form-control">{{ old('short_desc', $item->short_desc) }}</textarea>
                    </div>
                    <div class="col-12">
            ...
            <div class="admin-card rounded-4 bg-white p-4 mt-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div><h2 class="h5 fw-bold mb-1">Detail Layanan</h2><p class="small text-secondary mb-0">Tambahkan poin ruang lingkup.</p></div>
                    <button type="button" class="btn btn-outline-dark btn-sm" data-add-row="#detailsRows" data-template="#detailTemplate"><i class="bi bi-plus-lg me-1"></i>Tambah</button>
                </div>
        ...
        <div class="col-12 col-xl-4">
            ...
            <div class="d-grid gap-2 mt-4">
                ...
                <a href="{{ route('admin.services.index') }}" class="btn btn-light border">Batal</a>
            </div>
        </div>
    </div>
</form>
